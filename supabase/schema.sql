...
CREATE TABLE IF NOT EXISTS public.product_supplier_matches (
  ...
  match_reason text,
  tier text NOT NULL DEFAULT 'candidate' CHECK (tier IN ('recommended', 'candidate')),
...
CREATE INDEX IF NOT EXISTS idx_product_supplier_matches_report_id ON public.product_supplier_matches(report_id);
...
-- ============================================================================
-- PART 5B: Storage bucket and RLS
-- ============================================================================

-- Create uploads bucket without using storage.create_bucket
...
-- Restrict access to user-owned prefixes in uploads bucket
